import { DiaryContainer, ResultTitle, Divider, CardContainer, CardTitle, CardContent, ActionListItem } from './CommonStyles';

import { LoadingOutlined, CheckCircleTwoTone, HeartTwoTone, SmileTwoTone, MessageTwoTone, SoundTwoTone } from '@ant-design/icons';
...
const DiaryDisplay = ({ data, isLoading }) => {
	return (
		<DiaryContainer>
			...
			<CardContainer>
				<CardTitle>
					<MessageTwoTone twoToneColor={'#B5EAD7'} style={{ marginRight: '6px' }} />
					심리 분석
				</CardTitle>
